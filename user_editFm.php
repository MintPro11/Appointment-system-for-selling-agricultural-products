...
<body>
    <script src="js/bootstrap.min.js"></script>
            ...
            <br>
        <div class= "first">
            <h1 class= "a" text-align="center">Edit Form</h1>
        </div>&nbsp;
    <?php
        $id = $_GET['id'];
        //echo " $id";
    ...
    ?>
            ...
            <div class="container-sm">
                <form action="./user_editFm_db.php" method="$_GET">
                ...
                <input type="hidden" name="id_form" value="<?php echo $row['id_form']; ?>">
                    ...
                    <div class="row">
                        <div class="col">
                            <label for="name1" class="form-label" >ชื่อผู้นัดขาย</label>
                            <input type="text" class="form-control" name="name1" placeholder="ชื่อ-นามสกุล" required readonly value="<?php echo $row['name1']; ?>">
                        </div>
                        <div class="col">
                    ...
                    <button type="button" class="btn btn-secondary"><a href="./user_showFm.php" style="text-decoration:none;"> <font color="white">Return</font></a></button>
                </form>
            </div>
