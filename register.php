...
<body>
    ...
    <br>
    <div class= "first">
        <h1 class= "a" text-align="center">Register Page</h1>
    </div>
<div class="container-sm p-5">
    ...
    <form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post">
        ...
        <button type="button" class="btn btn-secondary"><a href="./register.php" style="text-decoration:none;"> <font color="white">Reset</font></a></button>
        <p style= "display: inline">If already registered</p>
        <button type="button" class="btn btn-secondary"><a href="./loginSite.php" style="text-decoration:none;"> <font color="white">Login</font></a></button>
