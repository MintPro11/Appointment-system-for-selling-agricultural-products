...
<body>
    ...
    <?php
        ...
        $query = "SELECT id_form,date1,time1,name1,phone,unit,status  FROM form_user WHERE name1 ='$check' ";
        ...
        foreach ($result as $row) { ?>
            <tr>
                ...
                <td> <a href="user_editFm.php?id=<?php echo $row['id_form']; ?>">Edit</a>
                <a href="./user_deleteFm.php?id=<?php echo $row['id_form']; ?>">Delete</a></td>
            </tr>  
